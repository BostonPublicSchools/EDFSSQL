...
-- Description:	Get evaluation standards rating by  PlanID and JobCode
-- =============================================
CREATE PROCEDURE [dbo].[getEvalStandardsRatingByPlanIDJobCode]
	@PlanID as int 
	,@JobCode as nchar(6)
AS
BEGIN
...
left join Evaluation e on e.EvalID = esr.EvalID 
