...
CREATE PROCEDURE [dbo].[CheckForeignKey] @CodeID NCHAR(10)
AS
    BEGIN
        ...
        FOR
            ...
            FROM    INFORMATION_SCHEMA.TABLE_CONSTRAINTS tc
                    ...
                    JOIN INFORMATION_SCHEMA.CONSTRAINT_COLUMN_USAGE ccu2 ON tc2.CONSTRAINT_NAME = ccu2.CONSTRAINT_NAME
            WHERE   tc.CONSTRAINT_TYPE = 'Foreign Key'
                    AND tc2.TABLE_NAME = 'CodeLookUp'
                    AND ccu2.COLUMN_NAME = 'CodeID'
